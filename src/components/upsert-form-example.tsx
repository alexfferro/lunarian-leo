...
const formSchema = z.object({
  name: z.string().trim().min(1, {
    message: "O nome de usuário é obrigatório e não pode estar em branco",
  }),
  amount: z
    .number({
      required_error:
        "O valor da transação é obrigatório e não pode ser negativo",
    })
    .positive({
      message: "O valor da transação é obrigatório e não pode ser negativo",
    }),
